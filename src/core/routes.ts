...
import PortfolioRouter from "../files/portfolio/portfolio.route";  // Import the Portfolio routes
...
export const routes = (app: Application) => {
  ...
  app.use(`${base}/portfolio`, PortfolioRouter); // Add the Portfolio routes
};
